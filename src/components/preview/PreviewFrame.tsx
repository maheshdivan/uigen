...
export function PreviewFrame() {
  ...
  if (error) {
    if (error === "firstLoad") {
      return (
        <div
          className="h-full flex items-center justify-center p-8 relative overflow-hidden bg-white"
          style={{
        ...
        >
          <div className="text-center max-w-sm relative z-10">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 mb-5 shadow-2xl shadow-indigo-500/30">
            ...
            <p className="text-sm text-neutral-500 mb-1">
              Your component renders here in real time
            </p>
